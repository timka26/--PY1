...
def to_csv_file(NAME, header, rows, delimiter=",", next_str="\n"):
    with open(NAME, "w") as f:
        f.write(delimiter.join(header) + next_str)
        f.writelines("".join(delimiter.join(row) + next_str for row in rows))
